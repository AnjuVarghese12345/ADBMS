...
alter table regions modify region_name varchar(50);
INSERT INTO regions(region_id,region_name) VALUES (4,'Middle East and Africa');

alter table locations drop foreign key locations_ibfk_1;

alter table countries modify country_id varchar(3);

alter table locations modify country_id varchar(3);
...
alter table countries modify country_name varchar(50);
...
alter table locations modify city varchar(50);
...
alter table jobs modify job_title varchar(20);
...
alter table jobs modify job_title varchar(50);
...
alter table jobs modify job_title varchar(30);
...
alter table employees modify email varchar(40);
...
INSERT INTO
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES(206,'William','Gietz','william.gietz@sqltutorial.org','515.123.8181','1994-06-07',1,8300.00,205,11);
...
select employees.first_name, employees.last_name from employees join jobs where employees.job_id=jobs.job_id and jobs.job_title like "shipping clerk";
...
delete from departments where department_name like "shipping";
